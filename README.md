...
**앞선 저장소는 모델 결과를 통해 이 결론에 도달했고, 이번에는 사람이 눈으로 관찰해
...
## 확보한 자료
    ...
    발연 (양성)   출처 15개 · 초당 2장으로 982장 · 학습 후보 350장
    김 (음성)     급식실 11곳 · 2,233장 · 서로 다른 것 2,044장
    배경 (음성)   급식실 정상 조리 · 서로 다른 것 207장
...
**슬로우모션이라 서로 다른 것이 10장뿐임.** 우리가 정한 출처당 하한이 10장이므로
**한 장이라도 적었으면 이 출처를 빼고 배정을 다시 짜야 했음.**
설계가 막아 준 것이 아니라 운이 좋았던 것이며, 하한에 걸리는 출처가 있을 수 있다는
것을 **추출 전에** 확인했어야 함.
